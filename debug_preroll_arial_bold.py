#!/usr/bin/env python3
"""
Debug script to test preroll description Arial Bold formatting
"""
...
def test_preroll_arial_bold():
    """Test if preroll descriptions get Arial Bold formatting."""
    ...
    print("Testing preroll description Arial Bold formatting...")
    print(f"Test record: {test_record}")
    
    try:
        # Test with mini template (should have DescAndWeight placeholder)
        print("\n1. Testing with mini template...")
        tp = TemplateProcessor(template_type='mini', font_scheme='Arial')
