#!/bin/bash
# Fix file persistence in uploads directory
echo "Fixing file persistence in uploads directory..."

# Create backup
cp /home/adamcordova/AGTDesigner/app.py /home/adamcordova/AGTDesigner/app.py.backup.$(date +%Y%m%d_%H%M%S)

# Create improved app.py with better file handling
...
if [ $? -eq 0 ]; then
    ...
    echo "✅ Added file existence verification!"
    echo "✅ Added file size logging!"
    echo "✅ Added /api/file-info endpoint!"
    echo "✅ Improved file persistence!"
    echo "Reloading web app..."
    touch /var/www/www_agtpricetags_com_wsgi.py
    echo "Web app reloaded! Files should persist now."
else
...
echo "File persistence fix applied successfully!"
