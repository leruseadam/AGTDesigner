#!/bin/bash
# Deploy the working app.py to PythonAnywhere
echo "Deploying working app.py to PythonAnywhere..."

# Create a script that will be run on PythonAnywhere
cat > deploy_to_pythonanywhere.sh << 'EOF'
#!/bin/bash
# Deploy working app.py to PythonAnywhere
...
# Create the working app.py
cat > /home/adamcordova/AGTDesigner/app.py << 'APP_EOF'
import os
import sys
import json
import pandas as pd
...
if [ $? -eq 0 ]; then
    ...
    echo "✅ Working app.py deployed to PythonAnywhere!"
...
echo "✅ Created deployment script: deploy_to_pythonanywhere.sh"
echo ""
echo "To deploy to PythonAnywhere, run:"
echo "bash deploy_to_pythonanywhere.sh"
echo ""
echo "This will:"
echo "✅ Backup current app.py"
echo "✅ Deploy working app.py with all fixes"
echo "✅ Verify syntax"
echo "✅ Reload web app"
echo "✅ Fix upload timing issues"
