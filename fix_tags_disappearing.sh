#!/bin/bash
# Fix tags disappearing after loading
echo "Fixing tags disappearing after loading..."

# Create backup
cp /home/adamcordova/AGTDesigner/app.py /home/adamcordova/AGTDesigner/app.py.backup.$(date +%Y%m%d_%H%M%S)

# Create improved app.py with better data handling
...
if [ $? -eq 0 ]; then
    ...
    echo "✅ Added /api/available-tags endpoint!"
    echo "✅ Added /api/initial-data endpoint!"
    echo "✅ Improved data persistence!"
    echo "Reloading web app..."
    touch /var/www/www_agtpricetags_com_wsgi.py
    echo "Web app reloaded! Tags should persist now."
else
...
echo "Tags disappearing fix applied successfully!"
