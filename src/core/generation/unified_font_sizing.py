...
def _load_font_sizing_config():
    ...
    if os.path.exists(config_path):
        ...
        return {
            'standard': {
                'mini': {
                    'description': [(5, 18), (20, 17), (30, 16), (35, 15), (40, 14), (60, 13), (70, 12), (100, 10), (120, 9), (float('inf'), 8)],
                ...
                'horizontal': {
                    'description': [(10, 36), (20, 34), (25, 32), (30, 28), (40, 27), (50, 26), (60, 24), (65, 22), (70, 21), (100, 20), (120, 18), (float('inf'), 16)],
